    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                @auth
                    @can('create', App\Model\Vacante::class)
                        <a class="mr-2 w-7 h-7 bg-indigo-500 hover:bg-indigo-600 rounded-full flex flex-col justify-center items-center text-white font-extrabold text-sm"
                ...
                @endauth
                {{-- Directiva cuando el usuario no esta autenticado --}}
                @guest
                    <!-- Navigation Links -->
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                @can('create', App\Model\Vacante::class)
                    <div class="flex gap-2 items-center p-3">
                        <a class="w-7 h-7 bg-indigo-500 hover:bg-indigo-600 rounded-full flex flex-col justify-center items-center text-white font-extrabold text-sm"
                            href="{{ route('notificaciones') }}">{{ Auth::user()->unreadNotifications->count() }}</a>
