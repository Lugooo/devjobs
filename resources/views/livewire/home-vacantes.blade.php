                    ...
                    <div class="md:flex md:justify-between md:items-center py-5">
                        <div class="md:flex-1">
                            ...
                            <p class="font-bold text-xs text-gray-600">
                                ...
                                <span class="font-normal">{{ \Carbon\Carbon::parse($vacante->ultimo_dia)->format('d/m/Y')}}</span>
                            </p>
                        </div>

                        <div class="mt-5 md:mt-0">
                            <a 
                                class="bg-indigo-500 p-2 text-sm uppercase font-bold text-white rounded-lg block text-center" 
                                href="{{ route('vacantes.show', $vacante->id) }}">
                                Ver Vacante
                            </a>
                        </div>
